...
public class Main : MonoBehaviour
{
	...
	private void Start()
	{
		...
		if (isPC)
		{
			...
			Time.timeScale = dataHandle.gI().datajson.speed;
            Screen.SetResolution(dataHandle.gI().datajson.width, dataHandle.gI().datajson.height, fullscreen: false);
        }
    }
