...
public class ServerListScreen : mScreen, IActionListener
{
	...
	public static string smartPhoneVN = AssemblyCSharp.mod.data.dataHandle.gI().datajson.IpServer;

	public static string javaVN = AssemblyCSharp.mod.data.dataHandle.gI().datajson.IpServer;

    public static string smartPhoneIn = AssemblyCSharp.mod.data.dataHandle.gI().datajson.IpServer;

    public static string javaIn = AssemblyCSharp.mod.data.dataHandle.gI().datajson.IpServer;

    public static string smartPhoneE = AssemblyCSharp.mod.data.dataHandle.gI().datajson.IpServer;

    public static string javaE = AssemblyCSharp.mod.data.dataHandle.gI().datajson.IpServer;
