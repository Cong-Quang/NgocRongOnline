...
public class XmapData
{
    ...
    private void LoadLinkMapBase()
    {
        ...
        LoadLinkMapsFromFile("Dragonboy_vn_v231_Data\\TextData\\LinkMapsXmap.txt");
        LoadLinkMapsAutoWaypointFromFile("Dragonboy_vn_v231_Data\\TextData\\AutoLinkMapsWaypoint.txt");
        LoadLinkMapsHome();
        LoadLinkMapSieuThi();
        LoadLinkMapToCold();
    }
